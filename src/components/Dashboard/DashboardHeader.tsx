...
const DashboardHeader = ({ item, navigation, dashboard, me }: any) => {
    const avatarSource = item?.avatar ?? require("../../assets/images/costher.png");
    ...
    return (
        <View style={dashboardStyles.header}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate("Profile", { dashboard, me })}>
